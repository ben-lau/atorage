...
import type { MiddlewareContext, MiddlewareFunction, MiddlewareWithHooks } from '../../src/types';
...
describe('executePipeline', () => {
  ...
  it('propagates errors from middleware', async () => {
    ...
    await expect(executePipeline([mw], createCtx(), coreHandler)).rejects.toBe(error);
  });
